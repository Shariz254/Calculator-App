...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnAC, btnDel, btnAddition, btnSubtraction, btnMultiplication, btnDivision, btnDot, btnEquals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDot.setOnClickListener(new View.OnClickListener() {
            ...
            //check if dot_inserted is false -> append "."
        ...
        btnDivision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!curr.isEmpty()) {
                    ...
                    //check if operator_inserted = false -> append operator_inserted to curr
    ...
    public void backspace(){
        ...
        if(!curr.isEmpty()){
            //check if dot is last char -> set dot_inserted = false
            if (curr.substring(curr.length()-1, curr.length()).equals(".")) {
                dot_inserted = false;
            }

            // if operator is detected -> delete three digits from curr & set operator_inserted = false
            if (curr.substring(curr.length()-1, curr.length()).equals(" ")){
